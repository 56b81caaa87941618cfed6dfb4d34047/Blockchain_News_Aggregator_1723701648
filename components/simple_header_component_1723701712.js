...
Vue.component("simple_header_component_1723701712", {
    template: `
    <header id="header-section" style="min-height: 310px" class="w-full bg-gradient-to-r from-purple-600 to-pink-500">
        <nav id="nav-bar" class="bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg border-gray-200 py-2.5 dark:bg-gray-900 dark:bg-opacity-20 shadow-lg">
            <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a id="logo-link" href="#" class="flex items-center">
                    ...
                    <span id="app-name" class="self-center text-xl font-semibold whitespace-nowrap text-white">BlockchainInsight</span>
                </a>
                ...
                <div id="mobile-menu-2" class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
                    <ul id="nav-list" class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li id="nav-item-home"><a href="#" class="block py-2 pl-3 pr-4 text-white bg-purple-700 bg-opacity-50 rounded-lg lg:bg-transparent lg:text-white lg:p-0 dark:text-white hover:bg-purple-600 hover:bg-opacity-70 transition duration-300" aria-current="page">Latest Block Updates</a></li>
                        ...
                        <li id="nav-item-3"><a href="#" class="block py-2 pl-3 pr-4 text-white border-b border-gray-100 hover:bg-purple-600 hover:bg-opacity-70 lg:hover:bg-transparent lg:border-0 lg:hover:text-pink-300 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700 transition duration-300">Recent Smart Contracts</a></li>
                    </ul>
                </div>
            </div>
        </nav>
